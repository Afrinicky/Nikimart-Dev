...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  if (!product) return { title: "Product — NikiMart" };

  const title = `${product.name} — NikiMart`;
  const description = (product.description?.trim() || "Shop this and more on NikiMart.").slice(0, 200);
