...
/**
 * The bundle business's transactions as a spreadsheet.
 *
...
export async function GET(req: Request) {
  ...
  try {
    ...
    return workbookResponse([sheet], "bundle-transactions");
  } catch (error) {
    console.error("[data transactions export] failed", error);
