...
export default async function AdminAnnouncementsPage() {
  ...
  return (
    <div>
      <PanelHeading
        title="Announcements"
        subtitle="Broadcast to every agent. They appear under Notifications in the agent platform."
      />
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="flex gap-2">
                    <form action={setAnnouncementActive}>
                      ...
                      <button
                        type="submit"
                        className="niki-press rounded-lg bg-niki-surface px-3 py-1.5 text-[11px] font-bold text-niki-ink/65"
                      >
                    ...
                    <form action={deleteAnnouncement}>
                      ...
                      <button
                        ...
                        className="niki-press rounded-lg p-1.5 text-niki-ink/40 hover:bg-niki-danger/10 hover:text-niki-danger"
                      >
