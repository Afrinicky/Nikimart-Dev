...
export default async function AdminInvitesPage() {
  ...
  return (
    <Container className="py-8">
      <div>
        <h1 className="font-figures text-2xl font-bold text-niki-ink">Registration links</h1>
        <p className="mt-1 text-sm text-niki-ink/60">
          Invite agents directly, at whatever discount you choose. Nobody earns a referral share on
          these — the discount is Nickimart&apos;s, not a recruiter&apos;s.
        </p>
      </div>
