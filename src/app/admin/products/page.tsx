      ...
      <div className="mt-6 overflow-x-auto rounded-2xl bg-white ring-1 ring-black/5">
        <table className="w-full min-w-[720px] text-left text-sm">
          ...
          <tbody className="divide-y divide-black/5">
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    {p.isArchived ? (
                      <form action={restoreProduct}>
                        ...
                        <button
                          type="submit"
                          className="flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-semibold text-niki-success transition-colors hover:bg-niki-success/10"
                        >
                      ...
                      <DeleteButton
                        ...
                        title="Products with sales are archived, not deleted, so order history stays intact"
                      />
                    )}
                  </div>
                </td>
            ...
            {products.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-5 py-10 text-center text-sm text-niki-ink/50">
                  No products yet.
                </td>
              </tr>
            ) : null}
