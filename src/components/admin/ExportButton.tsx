...
export function ExportButton({
  ...
  return (
    <a
      ...
      download
      className="flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold text-niki-ink/70 ring-1 ring-niki-edge-strong transition-colors hover:bg-white"
    >
