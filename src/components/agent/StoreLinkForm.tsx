    ...
    <form onSubmit={submit} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-2 rounded-xl bg-niki-surface p-2">
          ...
          <CopyChip
            value={fullLink}
            className="bg-white text-niki-ink/70 ring-1 ring-niki-edge hover:bg-niki-black/5"
          />
          <a
            href={`/store/${preview}`}
            target="_blank"
            rel="noopener noreferrer"
            className="niki-press flex items-center gap-1.5 rounded-full bg-niki-black px-3 py-2 text-xs font-semibold text-white"
          >
