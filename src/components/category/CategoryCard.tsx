...
export function CategoryCard({ category }: { category: Category }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col items-center gap-2.5 rounded-2xl bg-white p-4 text-center ring-1 ring-niki-edge transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-niki-navy/10 hover:ring-niki-orange/30"
    >
